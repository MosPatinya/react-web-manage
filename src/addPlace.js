...
function Addplace() {
    ...
    const rating = 0;
    const status = 'false';
    const [type, setType] = useState('โปรดระบุหมวดหมู่');
    const [type2, setType2] = useState('โปรดระบุหมวดหมู่');
    const [type3, setType3] = useState('โปรดระบุหมวดหมู่');
    const [type4, setType4] = useState('โปรดระบุหมวดหมู่');
    const [type5, setType5] = useState('โปรดระบุหมวดหมู่');
    const [type6, setType6] = useState('โปรดระบุประเภท');
    const [type7, setType7] = useState('โปรดระบุประเภท');
    const [type8, setType8] = useState('โปรดระบุประเภท');
    const [type9, setType9] = useState('โปรดระบุประเภท');
    const [type10, setType10] = useState('โปรดระบุประเภท');
    const [latitude, setLatitude] = useState('');
    const [longitude, setLongitude] = useState('');
    const [latitude2, setLatitude2] = useState(0.1);
    const [longitude2, setLongitude2] = useState(0.1);
    const [latitude3, setLatitude3] = useState(0.1);
    const [longitude3, setLongitude3] = useState(0.1);
    const [latitude4, setLatitude4] = useState(0.1);
    const [longitude4, setLongitude4] = useState(0.1);
    const [latitude5, setLatitude5] = useState(0.1);
    const [longitude5, setLongitude5] = useState(0.1);
